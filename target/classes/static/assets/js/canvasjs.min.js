...
16|h[1]<<8|h[2]:0}function ka(h,m,w){return h in m?m[h]:w[h]}function La(h,m,w){if(v&&Za){var s=h.getContext("2d");Ma=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;ga=Qa/Ma;h.width=m*ga;h.height=w*ga;Qa!==Ma&&(h.style.width=m+"px",h.style.height=w+"px",s.scale(ga,ga))}else h.width=m,h.height=w}


function hb(h){if(!ib){var m=!1,w=!1;"undefined"===typeof pa.Chart.creditHref?(h.creditHref=X("iuuqr;..b`ow`rkr/bnl."),
...
h._creditLink.setAttribute("tabIndex",-1),h._creditLink.setAttribute("target","_blank"));h._creditLink&&h.creditHref&&h.creditText?(h._creditLink.parentElement||h._canvasJSContainer.appendChild(h._creditLink),h._creditLink.style.top=h.height-14+"px"):h._creditLink.parentElement&&h._canvasJSContainer.removeChild(h._creditLink)}}}
